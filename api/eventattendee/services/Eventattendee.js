...
module.exports = {
  ...
  fetchOfUser: async (params, user_id) => {
    ...
    const entry = await Eventattendee.forge(_.pick(params, 'id')).fetch({
  ...
  editOfUser: async (params, values, user_id) => {
    ...
    const check_entry = await Eventattendee.forge(_.pick(params, 'id')).fetch({
      withRelated: populate
    });
